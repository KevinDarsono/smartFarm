            ...
            <div class="d-flex">
                ...
                <ul class="navbar-nav me-auto mb-4 mb-lg-0">
                    <li class="nav-item px-2">
                        <a class="nav-link fw-medium" href="{{ route('auth.login') }}">
                             <button class="btn btn-lg btn-dark bg-gradient order-0">Masuk</button>
                        </a>
                    </li>
                    <li class="nav-item px-2">
                        <a class="nav-link fw-medium" href="{{ route('auth.register') }}">
                            <button class="btn btn-lg btn-dark bg-gradient order-0">Daftar</button>
                        </a>
                    </li>
                </ul>
